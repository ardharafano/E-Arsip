<?php
include("akses_admin.php"); // restriksi halaman admin
?>
<!DOCTYPE html>
<html lang="id">
  <head>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
	  <div class="container">
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand visible-xs-block visible-sm-block" href="#" target="_blank">Lemlit Univ. Trisakti</a>
		  <a class="navbar-brand hidden-xs hidden-sm" href="#">Lemlit Univ. Trisakti</a>
		</div>
		<div class="collapse navbar-collapse" id="myNavbar">
		  <ul class="nav navbar-nav navbar-left">
			...
			<li<?php if ($thisPage=="Data") echo " class=\"active\""; ?>><a href="data.php" data-toggle="tooltip" data-placement="bottom" title="Lihat Data "><span class="glyphicon glyphicon-list"></span> Lihat Data</a></li>
			<li<?php if ($thisPage=="Tambah") echo " class=\"active\""; ?>><a href="tambah.php" data-toggle="tooltip" data-placement="bottom" title="Tambah Data " ><span class="glyphicon glyphicon-user"></span> Tambah Data</a></li>
			<form name="cari" method="post" action="cari.php" role="search" class="navbar-form navbar-left">
				<div class="form-group">
					<input type="text" name="carijurnal" placeholder="Cari Jurnal " class="form-control">
				</div>
				<button type="submit" name="submit" id="submit" value="search" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Cari Data ">Cari</button>
			<a class="btn btn-info" href="https://dx.doi.org/" target="_blank">Cek DOI</a>
			</form>
			<div>			
		  </ul>
